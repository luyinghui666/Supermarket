...
//添加员工信息界面
public class Manadd extends JFrame{
	...
	public Manadd() {
		...
		JTextField t_sex=new JTextField();//姓名输入框
		...
		JButton j_add=new JButton("添加");//添加按钮
		j_add.setBounds(61,366,93,23);
		cp.add(j_add);
		...
		//添加按钮点击监听事件
		j_add.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent arg0){
                String id=t_id.getText();//从文本框中获取输入的工号、姓名、职位、性别、联系、密码
